 ...
 */
public class BallKickingSimulator extends JComponent {

    // Height and Width of our game
    static final int WIDTH = 1200;
    static final int HEIGHT = 900;
    //Title of the window
    String title = "Ball Kicking Simulator!!!!!!!";
    ...
    public void playSong(final String name) {
        try {
            ...
            try {
                ...
                Logger.getLogger(BallKickingSimulator.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String[] args) {
        ...
        BallKickingSimulator game = new BallKickingSimulator();
